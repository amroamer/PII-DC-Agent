...
export const IKC_ASSET_FIELDS: IkcFieldDef[] = [
  ...
  { key: "descriptionAr", header: "Description (AR)", aliases: ["Arabic Description", "Description Arabic", "الوصف"], required: false },
  ...
  { key: "owner", header: "Owner", aliases: ["Data Owner", "Business Owner", "Owner Id"], required: false },
  { key: "stewards", header: "Stewards", aliases: ["Data Steward", "Data Stewards", "Custodian"], required: false },
  ...
  { key: "piiFlag", header: "PII", aliases: ["Pii", "Contains PII", "PII Flag"], required: false },
  { key: "cdeFlag", header: "CDE", aliases: ["Critical Data Element", "Critical Data Element Asset Level", "CDE Flag"], required: false },
  ...
  { key: "numColumns", header: "Number of Columns", aliases: ["Column Count", "Columns", "Extmeta Num Columns"], required: false },
  { key: "numChildren", header: "Number of Children", aliases: ["Child Count", "Children", "Extmeta Num Children"], required: false },
  { key: "qualityScore", header: "Quality Score", aliases: ["Data Quality Score", "Attr Quality Score"], required: false },
  { key: "analysedRowCount", header: "Analysed Row Count", aliases: ["Row Count", "Analyzed Rows", "Attr Quality Analyzed Row Count"], required: false },
  { key: "tags", header: "Tags", aliases: ["Labels"], required: false },
];

export const IKC_ATTRIBUTE_FIELDS: IkcFieldDef[] = [
  { key: "ikcAssetId", header: "Asset ID", aliases: ["Parent Asset ID", "Table ID", "Data Asset ID", "Asset Id"], required: true },
  ...
  { key: "descriptionAr", header: "Description (AR)", aliases: ["Arabic Description", "Description In Arabic", "الوصف"], required: false },
  { key: "dataType", header: "Data Type", aliases: ["Logical Type", "Type", "Da Type"], required: false },
  { key: "nativeType", header: "Native Type", aliases: ["Physical Type", "Technical Type", "Da Native Type"], required: false },
  { key: "isPrimaryKey", header: "Primary Key", aliases: ["Is Primary Key", "PK"], required: false },
  { key: "nullable", header: "Nullable", aliases: ["Is Nullable", "Allows Null", "Da Nullable"], required: false },
  { key: "selectedDataClassName", header: "Data Class", aliases: ["Selected Data Class", "Selected Data Class Name", "Assigned Data Class"], required: false },
  { key: "selectedDataClassConfidence", header: "Data Class Confidence", aliases: ["Confidence", "Data Class Score", "Selected Data Class Confidence"], required: false },
  { key: "suggestedClasses", header: "Suggested Data Classes", aliases: ["Candidate Data Classes", "Suggested Classes"], required: false },
  { key: "columnDataClassification", header: "Column Classification", aliases: ["Data Classification", "Column Data Classification", "Confidentiality"], required: false },
  ...
  { key: "length", header: "Length", aliases: ["Column Length", "Size", "Da Length"], required: false },
  { key: "scale", header: "Scale", aliases: ["Numeric Scale", "Da Scale"], required: false },
  { key: "signed", header: "Signed", aliases: ["Is Signed", "Da Signed"], required: false },
